...
class SWLargeWidgetCollection: UIView {
...
extension SWLargeWidgetCollection {
    func setupView() {
        // collection
...
extension SWLargeWidgetCollection: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return SWWidgetManager.default.largeList.count
    }
...
extension SWLargeWidgetCollection: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: 326, height: 326)
    }
